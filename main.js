window.onload = function () {
	...
	var clearResults = function(deactivate) {
		d3.selectAll('#results h2, #results h3, #results p')
		.transition()
		.duration(150)
		.style('opacity',0)
		.each('end', function() {
	...
	d3.json("data.json", function(json) {
		...
		var triggerSearch = function(query) {
			...
			d3.selectAll(selectedCells).classed('active', true).data(queryResults).on('click', function(queryResult){
				...
				//TODO connect this api on click https://www.worldhumanitariansummit.org/fr/search/apachesolr_search?page=7&filters=type%3Afile
